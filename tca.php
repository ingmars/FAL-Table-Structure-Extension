...
$TCA['sys_file_mountpoints'] = array (
	...
	'interface' => array (
		'showRecordFieldList' => 'hidden,name,description,driver,driver_configuration'
	),
	...
	'columns' => array (
		...
		'driver' => array (		
			'exclude' => 0,		
			'label' => 'LLL:EXT:file/locallang_db.xml:sys_file_mountpoints.driver',		
			'config' => array (
				'type' => 'input',	
				'size' => '30',
			)
		...
		'driver_configuration' => array (		
			'exclude' => 0,		
			'label' => 'LLL:EXT:file/locallang_db.xml:sys_file_mountpoints.driver_configuration',		
			'config' => array (
				'type' => 'text',
				'cols' => '30',	
				'rows' => '5',
	...
	'types' => array (
		'0' => array('showitem' => 'hidden;;1;;1-1-1, name, description, driver, driver_configuration')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
